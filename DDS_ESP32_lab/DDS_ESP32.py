...
# # use the python command to set the seleted values values 
# DDS_0.initialise_viaSPI(PLL_div=20, AFP_select=0b00, send=True)
...
# hex_command = hex(DDS_0.set_amplitude(0,1023, send=False))
# print(hex_command)

# # doing a sequencial list of changes 
# example get a sequencial list of commands in hexadecimal string form
